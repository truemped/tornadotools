...
#
# Copyright (c) 2009 Ivan Sagalaev https://launchpad.net/~isagalaev
#
...
In the example above functions ``some_async_func`` and
``some_other_async_func`` are those that actually run an asynchronous process.
They should follow two conditions:
